...
With apologies to Her Majesty and the nations of the British Commonwealth, Spring's
documentation standard uses American spelling, including the following:
